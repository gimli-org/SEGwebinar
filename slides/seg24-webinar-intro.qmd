---
title: "py**GIMLi**"
subtitle: Geophysical modeling and inversion beyond the standard (test)
format:
  letterbox-revealjs:
    ...
    #header-logo: images/gimli_logo.png
    background-image: images/bg_light.png
    menu: false
...
cd SEGwebinar
```
3. Install the `pg` environment with required dependencies (in particular `pygimli=1.5.0`).
